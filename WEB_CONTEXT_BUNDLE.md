...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-1061-erd-s-problem-1061-770a6bbe-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-1061"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-1061-erd-s-problem-1061-770a6bbe-v1",
      "problem_contract_sha256": "0e1ca2fc8b960f098b3fd083ddd42348333f3626b7e2d483479d68d9ccc29263",
      "problem_id": "problem:um-ep-1061-erd-s-problem-1061-770a6bbe",
      "route_id": "route:um-ep-1061-erd-s-problem-1061-770a6bbe-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-1061-erd-s-problem-1061-770a6bbe-source-fidelity-01",
      "graph_id": "graph:um-ep-1061-erd-s-problem-1061-770a6bbe-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-1061-erd-s-problem-1061-770a6bbe-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-1061-erd-s-problem-1061-770a6bbe-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "How many solutions are there to $ \\sigma(a)+\\sigma(b)=\\sigma(a+b) $ with $a+b\\leq x$, where $\\sigma$ is the sum of divisors function? Is it $\\sim cx$ for some constant $c>0$?"
          },
          "statement_sha256": "c78977626d02e15e25fe78b7321a324078c6a795c7af64e9a4a99a278ad94646"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-1061-erd-s-problem-1061-770a6bbe-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-1061-erd-s-problem-1061-770a6bbe-root",
      "route_id": "route:um-ep-1061-erd-s-problem-1061-770a6bbe-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-1061-131a6a1c4036",
        "url": "https://www.unsolvedmath.com/problems/EP-1061"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
